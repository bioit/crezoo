/*
 * RemoveHandlingFileAction.java
 *
 * Created on December 15, 2005, 11:07 AM
 *
 ...
 * @author lami
 */
public class RemoveHandlingFileAction extends TgDbAction {
    
    /** Creates a new instance of RemoveHandlingFileAction */
    public RemoveHandlingFileAction() {
    }
    ...
    public String getName() {
        return "RemoveHandlingFileAction";
    }
...
//            modelManager.removeHandlingFile(Integer.parseInt(eid), caller);

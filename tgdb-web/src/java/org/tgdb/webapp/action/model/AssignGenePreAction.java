...
public class AssignGenePreAction extends TgDbAction {
    ...
    public boolean performAction(HttpServletRequest request, ServletContext context) throws ApplicationException {
        try {
            ...
            request.setAttribute("genes", modelManager.getUnassignedGenes(Integer.parseInt(eid), _caller.getPid(), "transgene", _caller));

...
<div id="wrap">
    ...
    <form method="post" action="Controller">
        <span class="header_01">Reference Link</span>
        ...
        <table>
            ...
            <tr>
                <td><input type="text" name="url" size="55" maxlength="500" value="http://"/></td>
            </tr>
            <tr>
                <td><b>Pubmed ID</b></td>
            </tr>
            <tr>
                <td><input type="text" name="pubmed" size="55" maxlength="500"/></td>
            </tr>
            <tr>
                <td><b>Is this the Primary Publication?</b> <input type="radio" name="primary" value="true"/> Yes <input type="radio" name="primary" value="false" checked="checked"/> No</td>
            </tr>
            <tr>
                <td><b>Category</b></td>
            </tr>

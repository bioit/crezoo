...
<%
 org.tgdb.model.modelmanager.StrainAlleleDTO sadto = (org.tgdb.model.modelmanager.StrainAlleleDTO)request.getAttribute("strainallele");
...
<head>
    ...
    <title>crezoo &mdash; edit allele and mutation</title>
...
<div id="wrap">
	...
	<div id="panel-right">
        ...
        <form action="Controller" method="post">
            <span class="header_01">Edit Allele &amp; Mutation</span>
        <table width="100%">
            <tr>
        ...
        <table class="block3" width="100%">
            ...
            <tr><td>&nbsp;</td></tr>
            <tr>
                <th class="block">Allele Type&nbsp;<a class="navtext" href="Controller?workflow=AddMutationTypeToAllele&amp;strainalleleid=<jsp:getProperty name="strainallele" property="id"/>" title="Add Mutation Type">Add</a></th>
            </tr>
            <m:iterate-collection collection="mutationtypes"> 
            <tr class="#?alt#">
                <td><a class="navtext" href="Controller?workflow=RemoveMutationTypeFromAllele&amp;strainalleleid=<jsp:getProperty name="strainallele" property="id"/>&amp;mutationtypeid=#:getId#" title="Remove Mutation Type" onclick="return confirm('Remove Mutation Type?')">Remove</a>&nbsp;#:getName#</td>
            </tr>
            </m:iterate-collection>
            <tr><td>&nbsp;</td></tr>
            <tr>
                <th class="block">Mutation Type Attributes</th>
            </tr>
            <tr>
                <td><input type="text" name="attributes" value="<%=sadto.getAttributes()%>" size="55" maxlength="500" /><br/><span style="font-size: 10px;font-style: italic">comma-separated values for multiple entries</span></td>
            </tr>
        </table>
        <table>
            <tr>

...
<head>
    ...
    <title>crezoo &mdash; assign transgene</title>
...
<div id="wrap">
	...
	<div id="panel-right">
        ...
        <form action="Controller" method="post">
            <span class="header_01">Assign Transgene</span>
        <table>
            <tr>
                <td><b>Transgene</b>&nbsp;<a class="navtext" href="Controller?workflow=CreateGeneFromModel" title="Create A New Transgene">Add</a></td>
            </tr>
            <tr>
                <td>

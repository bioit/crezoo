...
<head>
    ...
    <title>crezoo &mdash; add allele type</title>
...
<div id="wrap">
	...
	<div id="panel-right">
        ...
        <form action="Controller" method="post">
            <span class="header_01">Add Allele Type</span>
        <table>
            <tr><td><m:checkbox collection="types" emptyOption="true" idGetter="getMutantid" textGetter="getName" name="type"/></td></tr>
        </table>
        <table>
            <tr>
                <td>

...
<head>
    ...
    <title>crezoo &mdash; trangenic mice index</title>
...
<div id="wrap">
	...
	<div id="panel-right">
        ...
        <form action="Controller" method="post">
            <span class="header_01">Transgenic Mice Index</span>
            <table>
                <tr>
                    <td>
            ...
            <table class="data">
                <tr>
                    <th class="data" width="20%"><input type="submit" title="order by ID" name="byID" value="ID" /></th>
                    <th class="data" width="70%"><input type="submit" title="order by line name" name="byNAME" value="Line Name" /></th>
                    <th class="data" width="10%"><input type="submit" title="order by last update" name="byDATE" value="Last Update" /></th>
                </tr>
                <m:iterate-collection collection="modelsdto">
                    <tr class="#?alt#">
                        <td width="20%">#:getAccNr#</td>
                        <td width="70%"><a href="Controller?workflow=ViewModel&amp;expand_all=true&amp;name_begins=model.block&amp;eid=#:getEid#&amp;general=true" class="indexmain">#:getLineName#</a></td>

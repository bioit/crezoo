...
<head>
    ...
    <title>crezoo &mdash; create transgene</title>
...
<div id="wrap">
	...
	<div id="panel-right">
        ...
        <form action="Controller" method="post">
            <span class="header_01">Create Transgene</span>
            <table>
                <tr>
                ...
                <tr>
                    <td><input type="text" name="idgene" size="35" value="0"/></td>
                </tr>
                <tr>
                    <td><b>ENSEMBL ID</b></td>
                </tr>
                <tr>
                    <td><input type="text" name="idensembl" size="35" value="0"/></td>
                </tr>
                <tr>
                    <td><b>Expression</b></td>
                </tr>
                <tr>
                    <td><input type="text" name="geneexpress" size="35"/></td>
                </tr>
                <tr>
                    <td><b>Molecular Note</b></td>
                </tr>
                <tr>
                    <td><input type="text" name="molecular_note" size="35"/></td>
                </tr>
                <tr>
                    <td><b>Molecular Note URl</b></td>
                </tr>
                <tr>
                    <td><input type="text" name="molecular_note_url" size="70"/></td>
                </tr>
                <tr>
                    <td><b>Comment</b></td>
                </tr>
                <tr>
                    <td><textarea cols="35" rows="6" name="comm"></textarea></td>                        
                </tr>
            </table>
        <table>
            <tr>
                <td>
                    <p class="navtext">
                        <input type="submit" name="create_transgene" value="Save" title="Save" onclick="validate();return returnVal;"/>
